...
---[CLIENT AND MENU] Centers the frame relative to the whole screen and invalidates its layout. This overrides [Panel:Center](https://wiki.facepunch.com/gmod/Panel:Center).
---
---[(View on wiki)](https://wiki.facepunch.com/gmod/DFrame:Center)
function DFrame:Center() end

---[CLIENT AND MENU] Hides or removes the DFrame, and calls [DFrame:OnClose](https://wiki.facepunch.com/gmod/DFrame:OnClose).
---
...
---[CLIENT AND MENU] Determines whether or not the DFrame will be removed when it is closed. This is set with [DFrame:SetDeleteOnClose](https://wiki.facepunch.com/gmod/DFrame:SetDeleteOnClose).
---
...
---[CLIENT AND MENU] Gets whether or not the frame is part of a derma menu. This is set with [DFrame:SetIsMenu](https://wiki.facepunch.com/gmod/DFrame:SetIsMenu).
---
...
---[CLIENT AND MENU] Determines whether or not the DFrame is removed when it is closed with [DFrame:Close](https://wiki.facepunch.com/gmod/DFrame:Close).
---
...
---[CLIENT AND MENU] Adds or removes an icon on the left of the [DFrame](https://wiki.facepunch.com/gmod/DFrame)'s title.
---
...
---[CLIENT AND MENU] Sets whether or not the [DFrame](https://wiki.facepunch.com/gmod/DFrame) can be resized by the user.
---
--- This is achieved by clicking and dragging in the bottom right corner of the frame.
---
