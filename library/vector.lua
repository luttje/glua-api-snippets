...
---
---[(View on wiki)](https://wiki.facepunch.com/gmod/Vector:Add)
---@param vector Vector The vector to add.
function Vector:Add(vector) end

---[SHARED AND MENU] Returns an angle representing the normal of the vector.
---
---[(View on wiki)](https://wiki.facepunch.com/gmod/Vector:Angle)
...
---
---[(View on wiki)](https://wiki.facepunch.com/gmod/Vector:Cross)
...
---[SHARED AND MENU] Divide the vector by the given number, that means x, y and z are divided by that value. This will change the value of the original vector, see example 2 for division without changing the value.
---
---[(View on wiki)](https://wiki.facepunch.com/gmod/Vector:Div)
...
---[SHARED AND MENU] Returns if the vector is equal to another vector with the given tolerance.
---
---[(View on wiki)](https://wiki.facepunch.com/gmod/Vector:IsEqualTol)
...
---[SHARED AND MENU] Checks whenever all fields of the vector are 0.
---
---[(View on wiki)](https://wiki.facepunch.com/gmod/Vector:IsZero)
...
---[SHARED AND MENU] Scales the vector by the given number (that means x, y and z are multiplied by that value) or Vector.
---
...
---[SHARED AND MENU] Negates this vector, i.e. sets every component to the negative value of itself. Same as `Vector( -vec.x, -vec.y, -vec.z )`
---
...
---[SHARED AND MENU] Randomizes each element of this Vector object.
---
---[(View on wiki)](https://wiki.facepunch.com/gmod/Vector:Random)
...
---[SHARED AND MENU] Rotates a vector by the given angle.
--- Doesn't return anything, but rather changes the original vector.
---
---[(View on wiki)](https://wiki.facepunch.com/gmod/Vector:Rotate)
---@param rotation Angle The angle to rotate the vector by.
function Vector:Rotate(rotation) end

---[SHARED AND MENU] Copies the values from the second vector to the first vector.
---
---[(View on wiki)](https://wiki.facepunch.com/gmod/Vector:Set)
---@param vector Vector The vector to copy from.
function Vector:Set(vector) end

---[SHARED AND MENU] Sets the x, y, and z of the vector.
---
---[(View on wiki)](https://wiki.facepunch.com/gmod/Vector:SetUnpacked)
---@param x number The x component
---@param y number The y component
---@param z number The z component
function Vector:SetUnpacked(x, y, z) end

---[SHARED AND MENU] Substracts the values of the second vector from the orignal vector, this function can be used to avoid garbage collection.
---
---[(View on wiki)](https://wiki.facepunch.com/gmod/Vector:Sub)
---@param vector Vector The other vector.
...
---
---[(View on wiki)](https://wiki.facepunch.com/gmod/Vector:ToTable)
---@return table #The table with elements 1 = x, 2 = y, 3 = z.
function Vector:ToTable() end

---[SHARED AND MENU] Returns the x, y, and z of the vector.
---
---[(View on wiki)](https://wiki.facepunch.com/gmod/Vector:Unpack)
...
---[SHARED AND MENU] Returns whenever the given vector is in a box created by the 2 other vectors.
---
---[(View on wiki)](https://wiki.facepunch.com/gmod/Vector:WithinAABox)
...
---[SHARED AND MENU] Sets x, y and z to 0.
---
