...
---
--- **NOTE**: This function will silently fail if the `developer` [ConVar](https://wiki.facepunch.com/gmod/ConVar) is set to `0`. It is not networked to clients, except for the [listen server host](https://wiki.facepunch.com/gmod/Player:IsListenServerHost).
---
