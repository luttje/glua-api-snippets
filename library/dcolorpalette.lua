...
---[CLIENT] Internal helper function for DColorPalette:UpdateConVars.
---
...
---[CLIENT] Updates all the console variables set by DColorPalette:SetConVarR and so on with given color.
---
