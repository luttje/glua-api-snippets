...
local ACT = {
  ...
  LAST_SHARED_ACTIVITY = 2045, --[[ The largest activity number ]]
}
...
local CLASS = {
  ...
  CLASS_PLAYER_ALLY = 2, --[[ HL2 player allies - monster_barney, npc_citizen, hacked npc_manhack, and friendly npc_turret_floor. ]]
  CLASS_PLAYER_ALLY_VITAL = 3, --[[ HL2 vital player allies - npc_magnusson, npc_gman, npc_fisherman, npc_eli, npc_barney, npc_kleiner, npc_mossman, npc_alyx, npc_monk, npc_dog, and npc_vortigaunt at the end of EP2 (controlled by "MakeGameEndAlly" input). ]]
  CLASS_ANTLION = 4, --[[ HL2 antlions - npc_antlion, npc_antlionguard, and npc_ichthyosaur. ]]
  CLASS_BARNACLE = 5, --[[ HL2 barnacles - npc_barnacle. ]]
  CLASS_BULLSEYE = 6, --[[ HL2 bullseyes - npc_bullseye. ]]
  CLASS_CITIZEN_PASSIVE = 7, --[[ HL2 passive/non-rebel citizens - npc_citizen in the beginning of HL2. ]]
  CLASS_CITIZEN_REBEL = 8, --[[ HL2 unused. ]]
  CLASS_COMBINE = 9, --[[ HL2 combine troops - npc_combine, npc_advisor, apc_missile, npc_apcdriver, hostile npc_turret_floor, hostile npc_rollermine, npc_turret_ground when active, npc_turret_ceiling when active, and npc_strider when active (not being carried by the gunship). ]]
  CLASS_COMBINE_GUNSHIP = 10, --[[ HL2 combine aircrafts - npc_combinegunship, npc_combinedropship, and npc_helicopter. ]]
  CLASS_CONSCRIPT = 11, --[[ HL2 unused. ]]
  CLASS_HEADCRAB = 12, --[[ HL2 headcrabs - visible npc_headcrab. ]]
  CLASS_MANHACK = 13, --[[ HL2 manhacks - hostile npc_manhack not held by the gravity gun. ]]
  CLASS_METROPOLICE = 14, --[[ HL2 metro police - npc_metropolice and npc_vehicledriver. ]]
  CLASS_MILITARY = 15, --[[ HL2 combine military objects - func_guntarget, npc_spotlight, and active npc_combine_camera. ]]
  CLASS_SCANNER = 16, --[[ HL2 combine scanners - npc_cscanner and npc_clawscanner. ]]
  CLASS_STALKER = 17, --[[ HL2 stalkers - npc_stalker. ]]
  CLASS_VORTIGAUNT = 18, --[[ HL2 vortigaunts - npc_vortigaunt before the end of EP2 (controlled by "MakeGameEndAlly" input). ]]
  CLASS_ZOMBIE = 19, --[[ HL2 zombies - unslumped npc_zombie, npc_poisonzombie, npc_fastzombie, npc_fastzombie_torso, and npc_zombine. ]]
  CLASS_PROTOSNIPER = 20, --[[ HL2 snipers - npc_sniper and proto_sniper. ]]
  CLASS_MISSILE = 21, --[[ HL2 missiles - rpg_missile, apc_missile, and grenade_pathfollower. ]]
  CLASS_FLARE = 22, --[[ HL2 flares - env_flare. ]]
  CLASS_EARTH_FAUNA = 23, --[[ HL2 animals - npc_crow, npc_seagull, and npc_pigeon. ]]
  CLASS_HACKED_ROLLERMINE = 24, --[[ HL2 friendly rollermines - hacked npc_rollermine. ]]
  CLASS_COMBINE_HUNTER = 25, --[[ HL2 hunters - npc_hunter. ]]
  CLASS_MACHINE = 26, --[[ HL:S turrets - monster_turret, monster_miniturret, monster_sentry. ]]
  CLASS_HUMAN_PASSIVE = 27, --[[ HL:S friendly humans - monster_scientist. ]]
  CLASS_HUMAN_MILITARY = 28, --[[ HL:S human military - monster_human_grunt and monster_apache. ]]
  CLASS_ALIEN_MILITARY = 29, --[[ HL:S alien military - monster_alien_controller, monster_vortigaunt, monster_alien_grunt, monster_nihilanth, and monster_snark if it has an enemy of class CLASS_PLAYER, CLASS_HUMAN_PASSIVE, or CLASS_HUMAN_MILITARY. ]]
  CLASS_ALIEN_MONSTER = 30, --[[ HL:S monsters - monster_tentacle, monster_barnacle, monster_zombie, monster_gargantua, monster_houndeye, monster_ichthyosaur, and monster_bigmomma. ]]
  CLASS_ALIEN_PREY = 31, --[[ HL:S headcrabs - monster_headcrab. ]]
  CLASS_ALIEN_PREDATOR = 32, --[[ HL:S alien predators - monster_bullsquid, xen_tree, and xen_hull. ]]
  CLASS_INSECT = 33, --[[ HL:S insects - montser_roach and monster_leech. ]]
  CLASS_PLAYER_BIOWEAPON = 34, --[[ HL:S player bioweapons - hornet fired by a player. ]]
  CLASS_ALIEN_BIOWEAPON = 35, --[[ HL:S enemy bioweapons - hornet fired by anyone but a player, or monster_snark with no enemy or an enemy without the class CLASS_PLAYER, CLASS_HUMAN_PASSIVE, or CLASS_HUMAN_MILITARY. ]]
}
...
local COND = {
  ...
  COND_NO_WEAPON = 6, 
  COND_NONE = 0, --[[ No additional conditions are being played ]]
  COND_NOT_FACING_ATTACK = 40, 
  COND_NPC_FREEZE = 67, --[[ Freezes NPC movement ]]
  COND_NPC_UNFREEZE = 68, --[[ Unfreezes NPC movement ]]
...
You should never set this flag manually. ]]
  ...
  EFL_KEEP_ON_RECREATE_ENTITIES = 16, --[[ This is a special entity that should not be deleted when we restart entities only ]]
  ...
  EFL_DIRTY_ABSANGVELOCITY = 8192, --[[ Some dirty bits with respect to abs computations ]]
...
local MATERIAL_CULLMODE = {
  MATERIAL_CULLMODE_CCW = 0, --[[ Counter clock wise cull mode ]]
  MATERIAL_CULLMODE_CW = 1, --[[ Clock wise cull mode ]]
}
...
local MOVETYPE = {
  ...
  MOVETYPE_PUSH = 7, --[[ No clip to world, but pushes and crushes things. Need ent:SetSaveValue("m_flMoveDoneTime", somenumberbiggerthancurtime) or the entity won't move. ]]
...
local SCHED = {
  ...
  SCHED_FORCED_GO = 71, --[[ Force walk to position (debug). ]]
  SCHED_FORCED_GO_RUN = 72, --[[ Force run to position (debug). ]]
  ...
  SCHED_NPC_FREEZE = 73, --[[ Prevents movement until COND_NPC_UNFREEZE(68) is set. ]]
...
---@enum SCREENFADE
local SCREENFADE = {
  SCREENFADE.IN = 1, --[[ Fade out after the hold time has passed ]]
  SCREENFADE.OUT = 2, --[[ Fade in, hold time passes, disappear ]]
  SCREENFADE.MODULATE = 4, --[[ With white color, turns the screen black ]]
  SCREENFADE.STAYOUT = 8, --[[ No effects, never disappear ]]
  SCREENFADE.PURGE = 16, --[[ Appear, Disappear, no effects ]]
}
...
local SND = {
  ...
  SND_CHANGE_VOL = 1, --[[ Change sound vol ]]
  SND_CHANGE_PITCH = 2, --[[ Change sound pitch ]]
  ...
  SND_IGNORE_NAME = 512, --[[ Used to change all sounds emitted by an entity, regardless of scriptname ]]
...
local SNDLVL = {
  ...
  SNDLVL_55dB = 55, 
  SNDLVL_60dB or SNDLVL_IDLE = 60, --[[ Normal conversation, clothes dryer ]]
  SNDLVL_65dB = 65, --[[ Washing machine, dishwasher ]]
  SNDLVL_STATIC = 66, 
  SNDLVL_70dB = 70, --[[ Car, vacuum cleaner, mixer, electric sewing machine ]]
  SNDLVL_75dB or SNDLVL_NORM = 75, --[[ Busy traffic ]]
  SNDLVL_80dB or SNDLVL_TALKING = 80, --[[ Mini-bike, alarm clock, noisy restaurant, office tabulator, outboard motor, passing snowmobile ]]
  ...
  SNDLVL_140dB or SNDLVL_GUNFIRE = 140, --[[ Threshold of pain, gunshot, jet engine ]]
  SNDLVL_150dB = 150, 
...
local STENCILCOMPARISONFUNCTION = {
...
local TRANSMIT = {
  ...
  TRANSMIT_PVS = 2, --[[ Transmit when entity is in players view ]]
}
