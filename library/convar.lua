...
---[SHARED AND MENU] Tries to convert the current string value of a [ConVar](https://wiki.facepunch.com/gmod/ConVar) to a boolean.
---
...
---[SHARED AND MENU] Returns the default value of the [ConVar](https://wiki.facepunch.com/gmod/ConVar)
---
...
---[SHARED AND MENU] Returns the [Enums/FCVAR](https://wiki.facepunch.com/gmod/Enums/FCVAR) flags of the ConVar
---
...
---[SHARED AND MENU] Attempts to convert the [ConVar](https://wiki.facepunch.com/gmod/ConVar) value to a float
---
...
---[SHARED AND MENU] Attempts to convert the [ConVar](https://wiki.facepunch.com/gmod/ConVar) value to a integer.
---
...
---[SHARED AND MENU] Returns the maximum value of the [ConVar](https://wiki.facepunch.com/gmod/ConVar)
---
...
---[SHARED AND MENU] Returns the minimum value of the [ConVar](https://wiki.facepunch.com/gmod/ConVar)
---
...
---[SHARED AND MENU] Returns the name of the [ConVar](https://wiki.facepunch.com/gmod/ConVar).
---
...
---[SHARED AND MENU] Returns the current [ConVar](https://wiki.facepunch.com/gmod/ConVar) value as a string.
---
...
---[SHARED AND MENU] Returns whether the specified flag is set on the [ConVar](https://wiki.facepunch.com/gmod/ConVar)
---
...
---[SHARED AND MENU] Reverts [ConVar](https://wiki.facepunch.com/gmod/ConVar) to its default value
---
