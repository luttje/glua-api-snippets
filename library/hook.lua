...
---@overload fun(eventName: "LoadGModSaveFailed", identifier: any, func: fun(reason: string, workshopid: string))
...
---@overload fun(eventName: "PlayerEndVoice", identifier: any, func: fun(ply: Player, plyIndex: number))
...
---@overload fun(eventName: "PlayerStartVoice", identifier: any, func: fun(ply: Player, plyIndex: number))
...
---@overload fun(eventName: "PostDrawPlayerHands", identifier: any, func: fun(hands: Entity, vm: Entity, ply: Player, weapon: Weapon, flags: number))
...
---@overload fun(eventName: "PostDrawViewModel", identifier: any, func: fun(viewmodel: Entity, player: Player, weapon: Weapon, flags: number))
