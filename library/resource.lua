...
---
--- **WARNING**: There's a 8192 downloadable file limit. If you need more than 8192, consider using Workshop addons - [resource.AddWorkshop](https://wiki.facepunch.com/gmod/resource.AddWorkshop). You should also consider the fact that you have way too many downloads. This limit is shared among all resource.Add functions.
---
--- **NOTE**: The file must exist on the server or players will not download it!
---
...
---[SERVER] Adds a workshop addon for the client to download before entering the server. This will not "install" the addon on your server, see [Workshop for Dedicated Servers](https://wiki.facepunch.com/gmod/Workshop for Dedicated Servers) for installing Steam Workshop addons onto your servers.
---
