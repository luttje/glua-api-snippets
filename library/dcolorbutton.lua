...
---[CLIENT AND MENU] Returns value set by [DColorButton:SetDrawBorder](https://wiki.facepunch.com/gmod/DColorButton:SetDrawBorder). See that page for more info.
---
...
---[CLIENT AND MENU] Returns the unique ID set by [DColorButton:SetID](https://wiki.facepunch.com/gmod/DColorButton:SetID).
---
...
---[CLIENT AND MENU] Alias of [Panel:IsSelected](https://wiki.facepunch.com/gmod/Panel:IsSelected).
---
...
---[CLIENT AND MENU] Used internally by [DColorPalette](https://wiki.facepunch.com/gmod/DColorPalette) to detect which button is which.
---
