...
---[SHARED] Cancels a net message started by [net.Start](https://wiki.facepunch.com/gmod/net.Start), so you can immediately start a new one without any errors.
---
---[(View on wiki)](https://wiki.facepunch.com/gmod/net.Abort)
function net.Abort() end

---[SERVER] Sends the currently built net message (see [net.Start](https://wiki.facepunch.com/gmod/net.Start)) to all connected players.
...
---[SHARED] **INTERNAL**: You may be looking for [net.Receive](https://wiki.facepunch.com/gmod/net.Receive).
---
...
---[SHARED] Reads a [Color](https://wiki.facepunch.com/gmod/Color) from the current net message.
---
--- **WARNING**: You **must** read information in same order as you write it.
---
...
---[SHARED] Reads a [VMatrix](https://wiki.facepunch.com/gmod/VMatrix) from the received net message.
--- **WARNING**: You **must** read information in same order as you write it.
---
...
---[SHARED] Reads a player entity that was written with [net.WritePlayer](https://wiki.facepunch.com/gmod/net.WritePlayer) from the received net message.
---
...
---[SHARED] **INTERNAL**: Used internally by [net.ReadTable](https://wiki.facepunch.com/gmod/net.ReadTable).
---
...
---[SHARED] Reads a vector from the received net message. Vectors sent by this function are **compressed**, which may result in precision loss. See [net.WriteVector](https://wiki.facepunch.com/gmod/net.WriteVector) for more information.
---
--- **WARNING**: You **must** read information in same order as you write it.
---
...
---[SHARED] Appends a boolean to the current net message. Alias of [net.WriteBit](https://wiki.facepunch.com/gmod/net.WriteBit).
---
...
---[SHARED] Appends a [Color](https://wiki.facepunch.com/gmod/Color) to the current net message.
---
...
---[SHARED] Appends an entity to the current net message using its [Entity:EntIndex](https://wiki.facepunch.com/gmod/Entity:EntIndex).
---
...
---[SHARED] Appends a signed integer - a whole number, positive/negative - to the current net message. Can be read back with [net.ReadInt](https://wiki.facepunch.com/gmod/net.ReadInt) on the receiving end.
---
...
---[SHARED] Writes a [VMatrix](https://wiki.facepunch.com/gmod/VMatrix) to the current net message.
---
...
---[SHARED] Appends a player entity to the current net message using its [Entity:EntIndex](https://wiki.facepunch.com/gmod/Entity:EntIndex). This saves a small amount of network bandwidth over [net.WriteEntity](https://wiki.facepunch.com/gmod/net.WriteEntity).
---
...
---[SHARED] **INTERNAL**: Used internally by [net.WriteTable](https://wiki.facepunch.com/gmod/net.WriteTable).
---
