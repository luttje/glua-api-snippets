...
---[CLIENT AND MENU] Returns the active [DTab](https://wiki.facepunch.com/gmod/DTab) of this [DPropertySheet](https://wiki.facepunch.com/gmod/DPropertySheet).
---
...
---[CLIENT AND MENU] Returns a list of all tabs of this [DPropertySheet](https://wiki.facepunch.com/gmod/DPropertySheet).
---
...
---[CLIENT AND MENU] Returns whatever value was set by [DPropertySheet:SetShowIcons](https://wiki.facepunch.com/gmod/DPropertySheet:SetShowIcons).
---
---[(View on wiki)](https://wiki.facepunch.com/gmod/DPropertySheet:GetShowIcons)
---@return boolean #
function DPropertySheet:GetShowIcons() end

---[CLIENT AND MENU] Sets the active tab of the [DPropertySheet](https://wiki.facepunch.com/gmod/DPropertySheet).
---
...
---[CLIENT AND MENU] Creates a close button on the right side of the [DPropertySheet](https://wiki.facepunch.com/gmod/DPropertySheet) that will run the given callback function when pressed.
---
...
---[CLIENT AND MENU] Sets the width of the [DPropertySheet](https://wiki.facepunch.com/gmod/DPropertySheet) to fit the contents of all of the tabs.
---
