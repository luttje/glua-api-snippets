...
---[CLIENT] Used by DNumberScratch:PaintScratchWindow.
---
...
---[CLIENT] Does not trigger DNumberScratch:OnValueChanged
---
...
---[CLIENT] Forces the assigned ConVar to be updated to the value of this DNumberScratch
---
