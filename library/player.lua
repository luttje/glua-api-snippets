...
---[SHARED] See [GetCount](/gmod/Player:GetCount) for list of typesAdds an entity to the total count of entities of same type.
---
...
---@param limitType string Limit type. In unmodified Sandbox possible values are:
--- * "props"
--- * "ragdolls"
--- * "vehicles"
--- * "effects"
